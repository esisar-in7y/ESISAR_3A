...
public class calculchaine {
    ...
    //         targetHash = hash(String.format("%08d", reduction(String2Bytes(targetHash), i)), digest);
    //     }
    ...
    //                         System.out.println("candidatePx:"+candidatePx+" targetPx:"+targetP999+"candidatePwd:"+candidatePwd);
    //                     }
    //                     candidateHash = hash(candidatePwd, digest);
    //                     if (candidateHash.equals(targetBytes)) {
    //                         return candidatePwd;
    //                     }
    ...
    private static Noeud[] read() {
        ...
        try {
            ...
            while (myReader.hasNextLine()) {
                ...
                insert(table, Integer.parseInt(splited[1]),new Noeud(Integer.parseInt(splited[1]), Integer.parseInt(splited[0])));
            }
            myReader.close();
